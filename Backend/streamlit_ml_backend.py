...
def render_ml_backend():
    ...
    if st.session_state.df_if is not None and st.session_state.df_nv is not None:
        ...
        with col1:
            ...
            st.dataframe(st.session_state.df_if.head(5), width='stretch')
        with col2:
            st.markdown("**Novelty Train CSV — First 5 rows**")
            st.dataframe(st.session_state.df_nv.head(5), width='stretch')
    ...
    if st.session_state.if_results is not None:
        ...
        with col1:
            ...
            st.dataframe(st.session_state.if_results['top_view'], width='stretch')
        with col2:
    ...
    if st.session_state.test_results is not None:
        ...
        st.dataframe(st.session_state.test_results['scored_data'], width='stretch')
