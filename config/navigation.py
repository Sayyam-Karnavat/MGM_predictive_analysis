...
def render_sidebar_navigation():
    ...
    for page_name, page_info in PAGES.items():
        ...
        if is_selected:
            ...
            if st.sidebar.button(f"{page_info['icon']} {page_name}", key=f"nav_{page_name}", width='stretch'):
    ...
    if st.sidebar.button("🚀 Model Development Centre", width='stretch', type="primary"):
